...
public class MagicStandardMatrixFiller {
    ...
    public MagicStandardMatrixFiller() {
        this.matchScore = 3;
    ...
    public MagicStandardMatrixFiller(int matchScore, int mismatchScore, int gapPenalty) {
